...
public class PixelizeObject : ScriptableRendererFeature
{
    ...
    private static readonly RenderPassEvent pixelizeObjectRenderPassEvent = RenderPassEvent.AfterRenderingSkybox;
    ...
    class PixelizeObjectPass : ScriptableRenderPass
    {
        ...
        //定义一个 ProfilingSampler 方便设置在FrameDebugger里查看
        private const string ProfilerTag = "Pixelize Object Pass";
        private ProfilingSampler m_ProfilingSampler = new("Pixelize Object Pass");
    ...
    public override void SetupRenderPasses(ScriptableRenderer renderer, in RenderingData renderingData)
    {
        ...
        pixelizeObjectPass.Setup(renderer.cameraColorTargetHandle);
