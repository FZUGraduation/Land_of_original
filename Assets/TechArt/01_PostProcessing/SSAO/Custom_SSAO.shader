    ...
    SubShader
    {
        ...
        pass
        {
            ...
            half4 frag_AO (Varyings i) : SV_TARGET
            {
                ...
                float3 nDirWS = SAMPLE_TEXTURE2D_X(_m_CameraNormalsTexture,sampler_PointClamp,i.texcoord).xyz;
                ...
                for(int index = 1; index<=sampleCount; index++)
                {
                    ...
                    float OcculusionPointRawDepth = SAMPLE_TEXTURE2D(_m_CameraDepthTexture,sampler_PointClamp,randomSampleScreenPos).r;
        ...
        pass
        {
			...
			{
				float3 nDirWS = SAMPLE_TEXTURE2D_X(_m_CameraNormalsTexture,sampler_PointClamp,uv).xyz;
